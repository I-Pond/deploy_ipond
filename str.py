...
if not firebase_admin._apps:
    ...
    default_app = initialize_app(
        cred, {'databaseURL': 'https://datastreamlit-default-rtdb.asia-southeast1.firebasedatabase.app/'})

# Tentukan referensi ke node tertentu di database
ref = db.reference('prediksi_air')
